...
df_inegi <- df_homicides_state_monthly_inegi_ocurrencia                 %>% 
...
df_combined_wide <- df_inegi                                                 %>% 
        select(-source)                                                      %>% 
        rename(homicidios_inegi = homicidios, mort_rate_inegi = mort_rate)   %>% 
        ...
        select(entidad, state, año, year, mes, month, population, 
                homicidios_inegi, homicidios_sscp_gpo, homicidios_sscp_fa, 
                mort_rate_inegi, mort_rate_sspc_gpo, mort_rate_sscp_fa)
